...
from . import splash_templates
from .datastruct import Target, TOC
from .utils import misc, _check_guts_eq, _check_guts_toc
from .. import log as logging
from ..archive.writers import SplashWriter
from ..compat import is_cygwin, is_win
from ..depend import bindepend
from ..utils.hooks import exec_statement
from ..utils.tcl_tk import TK_ROOTNAME, collect_tcl_tk_files
...
class Splash(Target):
    ...
    def __init__(self, image_file, binaries, datas, **kwargs):
        ...
        tcl_tree, tk_tree = collect_tcl_tk_files(self._tkinter_file)
        if self.full_tk:
            # The user wants a full copy of tk, so make all tk files
            # a requirement
            self.splash_requirements.update(toc[0] for toc in tk_tree)
        ...
        if not self.uses_tkinter:
            ...
            self.binaries.extend(toc for toc in tk_tree
